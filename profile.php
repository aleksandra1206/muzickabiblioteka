...
<?php if ($userid != $loggedId) : ?>
    ...
    <div class="center">
        <a href="index.php" class="btn center pink darken-2">Return</a>
    </div>
                ...
                <div class="col s12 m6 l4 xl3">
                    <div class="card z-depth-0 radius-card">
                        ...
                        <div class="card-action right-align radius-card">
                            <a href="song.php?id=<?php echo $song['id']; ?>" class="pink-text text-darken-2">
                                More Info
                            </a>
                        </div>
                    </div>
...
<?php else : ?>
    ...
    <h1 class="center">You have not posted any songs!</h1>
    <div class="center">
        <a href="add.php" class="btn center pink darken-2">Add one</a>
    </div>
